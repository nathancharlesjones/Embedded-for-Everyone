...
/opt/gcc-arm/bin/arm-none-eabi-gcc -DCPU_LPC845M301JBD48 -mthumb -mcpu=cortex-m0 -Og -c -I ./include ./source/main.c ./source/clock_config.c ./source/fsl_clock.c ./source/fsl_reset.c ./source/fsl_gpio.c ./setup/system_LPC845.c ./source/fsl_common.c ./source/fsl_power.c ./setup/startup_LPC845.S
