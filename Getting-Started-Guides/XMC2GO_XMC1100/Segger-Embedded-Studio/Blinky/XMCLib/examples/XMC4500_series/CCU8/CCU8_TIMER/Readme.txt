...
The SCU driver is used to configure the clock settings and take the CCU8 peripheral 
out of reset. CCU8 APIs are used to configure a CCU8 slice to operate in timer mode. 
