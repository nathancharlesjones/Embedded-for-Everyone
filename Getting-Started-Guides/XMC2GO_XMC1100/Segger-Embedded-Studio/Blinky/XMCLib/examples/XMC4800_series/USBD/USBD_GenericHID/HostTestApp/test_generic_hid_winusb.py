...
def send_led_pattern(device, led1, led2):
    ...
    print("Sent LED Pattern: {0}".format(report_data[1:3]))


def received_led_pattern(report_data):
    print("Received LED Pattern: {0}".format(report_data[1:3]))
